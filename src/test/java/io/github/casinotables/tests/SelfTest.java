package io.github.casinotables.tests;

import io.github.casinotables.flight.FlightControls;
import io.github.casinotables.flight.FlightRules;
import io.github.casinotables.poker.PokerCard;
import io.github.casinotables.poker.PokerChips;
import io.github.casinotables.poker.PokerHandEvaluator;
import io.github.casinotables.poker.LuckyDeal;
import io.github.casinotables.poker.PokerMoney;
import io.github.casinotables.poker.PokerArenaStyle;
import io.github.casinotables.blackjack.BlackjackHand;
import io.github.casinotables.blackjack.BlackjackSeatHand;
import io.github.casinotables.arena.ArenaShape;
import io.github.casinotables.poker.CasinoBot;
import io.github.casinotables.poker.PokerBotStrategy;
...
public final class SelfTest {
    ...
    public static void main(String[] args) {
        ...
        io.github.casinotables.Messages.bindStandalone(loadLanguage("en_US"));
        testPoker();
        testPokerChips();
        testPokerMoney();
        ...
        testLanguageFiles();
        testBotArchetypes();
        check(io.github.casinotables.Messages.missingKeys().isEmpty(),
                "en_US.yml 缺少代码实际用到的键：" + io.github.casinotables.Messages.missingKeys());
